  ...
  en: {
    ...
    timer: {
      ...
      actions: {
        ...
        closeFullscreen: 'Close fullscreen timer',
      },
      completionToast: '%{phase} complete. Your radar signal updated.',
    },
    metrics: {
    ...
    tasks: {
      ...
      startTask: 'Start %{title}, %{minutes} minute focus block',
    ...
    stats: {
      ...
      zeroTotal: '0m total',
      emptyTitle: 'No focus data yet',
      emptyBody: 'Complete a focus block and your daily radar signal will start to grow.',
      trendUp: 'Up %{percent}% compared to the previous period',
      trendDown: 'Down %{percent}% compared to the previous period',
      trendNeutral: 'Same as the previous period',
      supportLink: 'Support TimeRadar',
      supportLinkHint: 'Opens supporter options in Settings',
    },
    settings: {
      title: 'Settings',
      language: 'Language',
    ...
    taskForm: {
      ...
      autoStartBreaks: 'Start breaks automatically',
      autoStartBreaksHelper: 'Move into break time automatically when focus ends.',
      advancedSettings: 'Advanced timer settings',
      showAdvanced: 'Show break and session settings',
      hideAdvanced: 'Hide break and session settings',
      createTask: 'Create focus task',
  ...
  ar: {
    ...
    timer: {
      ...
      actions: {
        ...
        closeFullscreen: 'إغلاق المؤقت بملء الشاشة',
      },
      completionToast: 'اكتملت %{phase}. تم تحديث إشارة الرادار.',
    },
    metrics: {
    ...
    tasks: {
      ...
      startTask: 'بدء %{title}، جلسة تركيز لمدة %{minutes} دقيقة',
    ...
    stats: {
      ...
      zeroTotal: 'إجمالي 0د',
      emptyTitle: 'لا توجد بيانات تركيز بعد',
      emptyBody: 'أكمل جلسة تركيز وستبدأ إشارة الرادار اليومية بالنمو.',
      trendUp: 'زيادة %{percent}% مقارنة بالفترة السابقة',
      trendDown: 'انخفاض %{percent}% مقارنة بالفترة السابقة',
      trendNeutral: 'مطابق للفترة السابقة',
      supportLink: 'دعم تايم رادار',
      supportLinkHint: 'يفتح خيارات الداعم في الإعدادات',
    },
    settings: {
      title: 'الإعدادات',
      language: 'اللغة',
    ...
    taskForm: {
      ...
      autoStartBreaks: 'بدء الاستراحات تلقائيًا',
      autoStartBreaksHelper: 'ابدأ الاستراحة تلقائيًا بعد انتهاء التركيز.',
      advancedSettings: 'إعدادات المؤقت المتقدمة',
      showAdvanced: 'إظهار إعدادات الاستراحة والجلسات',
      hideAdvanced: 'إخفاء إعدادات الاستراحة والجلسات',
      createTask: 'إنشاء مهمة تركيز',
